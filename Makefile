...
#     VERSION_FROM => q[lib/WWW/TamperData.pm]
#     clean => { FILES=>q[WWW-TamperData-*] }
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/WWW/TamperData.pm
...
TO_INST_PM = lib/WWW/TamperData.pm

PM_TO_BLIB = lib/WWW/TamperData.pm \
...
manifypods : pure_all  \
	lib/WWW/TamperData.pm
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/WWW/TamperData.pm $(INST_MAN3DIR)/WWW::TamperData.$(MAN3EXT) 
